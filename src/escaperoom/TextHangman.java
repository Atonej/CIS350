...
/******************************************************************
 * This text version of hangman program will run a screen of hangman where the
 * user guesses a word
 * 
...
public class TextHangman {
	...
	public int hangmanGame() // game of hangman, enter letter and receive word
	{
		...
		System.out.println(
				"I invite you to try and guess the word I am thinking.......\n");
		System.out.println(
				"You have 10 tries to be incorrect otherwise you continue into the next round and I show you the word!\n");
		System.out.println(
				"HINT: I happen to show a likeness to the biological life that's not humans\n");
		System.out.println(
				"However for each moment you are incorrect I draw a line that leads closer to a stick figure man");
		System.out.println(
		...
		do {
			...
			if (correctGuess != 1) {
				...
				System.out.println(" Wrong guess! Try again\n "
						+ "You made " + (wrongGuesses + 1)
						+ " wrong attempts " + "be careful!!\n\n");
	...
	public void help_menu_main() {
		System.out.println(
				"If you would like to play the game hit the P character, if you do not want to play hit the Q key.\n");
		System.out.println(
				"This program is not key sensitive, but choose one of the 3 options shown on the main menu.\n\n");
